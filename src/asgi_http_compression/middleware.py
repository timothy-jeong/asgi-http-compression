...
from asgi_http_compression.types import ASGIApp, Receive, Send, Scope
...
class CompressionMiddleware:
    def __init__(
        ...
        #NOTE: Register the supported compression methods and their factories (creation functions)
